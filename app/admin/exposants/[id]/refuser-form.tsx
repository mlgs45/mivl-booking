...
import { refuserExposant, type AdminActionState } from "./actions";

export function RefuserForm({ exposantId }: { exposantId: string }) {
    ...
    <div className="flex-1">
      {!open ? (
        ...
        <form action={action} className="space-y-3">
          ...
          <textarea
            name="motifRefus"
            placeholder="Motif du refus (transmis à l'exposant par email)"
            rows={3}
            autoFocus
            required
            minLength={10}
