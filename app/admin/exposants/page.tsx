...
export const metadata = { title: "Exposants — Admin MIVL" };
    ...
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          <div>
            <div className="flex items-center gap-2 text-sm text-neutral-700 mb-1">
              ...
              <span>/</span>
              <span className="text-neutral-900 font-medium">Exposants</span>
            </div>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <FilterLink href="/admin/exposants" active={!filterStatut} label="Tous" count={total} />
          {STATUT_ORDER.map((s) => (
            <FilterLink
              key={s}
              href={`/admin/exposants?statut=${s}`}
        ...
        {exposants.length === 0 ? (
          <div className="text-center py-20 text-neutral-700">
            <p>Aucun exposant dans cette catégorie.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead className="bg-neutral-50 border-b border-neutral-100">
                <tr>
                  ...
                  <th className="text-left px-4 py-3 font-semibold text-neutral-700 hidden lg:table-cell">Màj</th>
                ...
                {exposants.map((e) => {
                  ...
                  const secteurLabel =
                    e.secteurs.length > 0
                      ...
                      : "—";
                  const extraSecteurs = e.secteurs.length - 1;
                  return (
