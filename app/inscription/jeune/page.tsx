...
import { InscriptionJeuneForm } from "./inscription-form";

export const metadata = { title: "Inscription jeune / diplômé — MIVL Connect" };
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white rounded-xl border border-neutral-100 p-8 sm:p-10">
            ...
            <p className="text-neutral-700 mb-8">
              Inscrivez-vous pour le speed dating de l'après-midi du 15 octobre 2026 et décrochez jusqu'à 6 rendez-vous de 5 minutes avec les exposants de votre choix.
            </p>
            ...
            <div className="mb-8 rounded-lg bg-primary/5 border border-primary/10 p-4 text-sm text-neutral-900">
              ...
              <ol className="mt-2 space-y-1 text-neutral-700 list-decimal list-inside">
                ...
                <li>Découverte des exposants et de leurs offres</li>
                <li>Sélection de 1 à 6 rendez-vous</li>
                <li>Planning confirmé par email</li>
              </ol>
            </div>

            <InscriptionJeuneForm />
          </div>
        </div>
      </main>
      <PublicFooter />
