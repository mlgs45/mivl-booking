  ...
  const exposantsData = [
    {
      ...
      secteurs: ["AUTO_FERRO_AERO_DEFENSE", "ELEC_MECA_ROBOT_DIGITAL"],
      ville: "Orléans",
      codePostal: "45000",
      ...
      elementsStand: ["PRODUITS_FABRIQUES", "MACHINE_EQUIPEMENT", "DEMONSTRATION_TECHNIQUE"],
      animations: ["DEMONSTRATION", "TEMOIGNAGE_SAVOIR_FAIRE"],
      innovationMiseEnAvant: true,
      descriptionInnovation:
        "Procédé d'usinage 5 axes pour pièces titane à tolérance micrométrique.",
    ...
    },
    {
      ...
      secteurs: ["PHARMA_MEDICAL_COSMETIQUE"],
      ville: "Chartres",
      codePostal: "28000",
      ...
      elementsStand: ["PRODUITS_FABRIQUES", "SUPPORTS_PEDAGOGIQUES"],
      animations: ["PRESENTATION_INNOVATION"],
      innovationMiseEnAvant: false,
      statutRecrutement: "OUI" as const,
      ressourcesMatin: 2,
    ...
    },
    {
      ...
      secteurs: ["PLASTURGIE_CHIMIE", "AUTO_FERRO_AERO_DEFENSE"],
      ville: "Blois",
      codePostal: "41000",
      ...
      elementsStand: ["MACHINE_EQUIPEMENT", "DEMONSTRATION_TECHNIQUE"],
      animations: [],
      innovationMiseEnAvant: false,
    ...
    },
    {
      ...
      secteurs: ["AUTRES_INDUSTRIES", "ENERGIE"],
      ville: "Bourges",
      codePostal: "18000",
    ...
    },
    {
      ...
      secteurs: ["ELEC_MECA_ROBOT_DIGITAL"],
      ville: "Tours",
      codePostal: "37000",
      ...
      elementsStand: ["PROTOTYPE_INNOVATION", "SUPPORTS_PEDAGOGIQUES"],
      animations: ["PRESENTATION_INNOVATION", "MINI_CONFERENCE"],
      innovationMiseEnAvant: true,
      descriptionInnovation:
        "Plateforme IoT temps réel pour le monitoring des chaînes de production.",
      statutRecrutement: "OUI" as const,
      ressourcesMatin: 2,
      ressourcesApresMidi: 3,
    },
  ...
  for (const ex of exposantsData) {
    ...
    const exposant = await db.exposant.create({
      data: {
        ...
        secteurs: ex.secteurs,
        secteurAutre: ex.secteurAutre ?? null,
        ville: ex.ville,
        ...
        elementsStand: ex.elementsStand,
        animations: ex.animations,
        innovationMiseEnAvant: ex.innovationMiseEnAvant,
        descriptionInnovation: ex.descriptionInnovation ?? null,
        statutRecrutement: ex.statutRecrutement,
